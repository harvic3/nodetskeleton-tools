# Tools for NodeTSkeleton

This project is a set tools for `NodeTSkeleton` template.
...
Although these tools were developed to be used with `NodeTskeleton`, they can also be used in any `NodeJs` project.
